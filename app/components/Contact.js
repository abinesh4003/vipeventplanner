...
return (
  <section id="contact" className="py-14 sm:py-16 bg-[#fdfbf7] text-[#222] font-montserrat">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-lg border border-[#eee]">
            ...
            <div className="space-y-5 sm:space-y-6">
              {[
                ...
                { Icon: Mail, label: "Email Us", value: "info@vipfunctionplanners.com", href: "mailto:info@vipfunctionplanners.com" },
            ...
            {/* Socials */}
            <div className="mt-8">
              <p className="font-medium mb-3 text-xs sm:text-sm text-[#777] uppercase tracking-wide">
                Follow Us
              </p>
              <div className="flex gap-3">
                {[Instagram, Facebook, Youtube].map((Icon, i) => (
                  <a key={i} href="#" className="bg-gold/10 p-2.5 sm:p-3 rounded-full hover:bg-gold/20 transition">
                    <Icon className="text-gold" size={18} />
                  </a>
                ))}
              </div>
