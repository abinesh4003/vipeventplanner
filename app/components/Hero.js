...
const VipEventManagementHero = () => {
    ...
    return (
        <div className="relative max-h-screen flex flex-col justify-center overflow-hidden">
            ...
            {/* <div className="absolute inset-0 z-10 bg-gradient-to-b from-white/20  to-white/20"></div> */}
            ...
            <div className="relative z-20 w-full px-6 sm:px-8 md:px-12 pt-8 sm:pt-12">
                <div className="max-w-6xl mx-auto text-center space-y-4">
                    ...
                    <div className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gold drop-shadow-2xl px-4 min-h-[120px] sm:min-h-[140px] md:min-h-[160px] flex items-center justify-center" aria-hidden="true">
                    ...
                    <div className="text-lg sm:text-xl md:text-2xl italic font-light drop-shadow-lg px-4 min-h-[60px] sm:min-h-[70px] flex items-center justify-center">
                        <AnimatePresence mode="wait">
                            <motion.p
                                key={currentIndex}
                    ...
                    <div className="flex flex-row gap-3 justify-center items-center ">
                        <Link href="/contact" className="inline-block">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="group relative px-4 py-2 border-2 border-gold text-gold hover:bg-gold hover:text-black transition-all duration-500 font-bold text-xs sm:text-base flex items-center gap-2 shadow-2xl overflow-hidden whitespace-nowrap"
                            >
                        ...
                        <Link href="tel:8778304145" className="inline-block">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="px-4 py-2   border-2 border-black/50 text-black hover:bg-white hover:text-black transition-all duration-500 font-bold text-xs sm:text-base flex items-center gap-2 shadow-2xl whitespace-nowrap"
                            >
                                <Phone size={18} />
                                CALL NOW
                            </motion.button>
